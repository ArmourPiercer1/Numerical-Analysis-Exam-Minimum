...
\begin{enumerate}
    ...
    \begin{align}
        \begin{cases}
            \left|1-\dfrac{\lambda_1}{\mu}\right|<1 \Rightarrow \mu\in (0,\dfrac{\lambda_1}{2})\\
            \left|1-\dfrac{\lambda_n}{\mu}\right|<1 \Rightarrow \mu\in (0,\dfrac{\lambda_n}{2})
        \end{cases}
    \end{align}
    取交集解得
    \begin{align}
        \mu\in (0,\dfrac{\lambda_n}{2})
    \end{align}

    即 
    \begin{align}
        0<\mu<\frac{\lambda_{\min}(A)}{2}
    \end{align}
